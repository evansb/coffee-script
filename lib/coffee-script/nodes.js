...
(function() {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, boundfunc, callback, code, exprs, i, lit, p, param, params, promise, ref, splats, uniqs, val, wasEmpty, wrapper, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      if (this.bound && ((_ref2 = o.scope.method) != null ? _ref2.bound : void 0)) {
        this.context = o.scope.method.context;
      }
      if (this.isAsync) {
        this.isAsync = false;
        callback = new Code([], this.body);
        callback.bound = this.bound;
        promise = new Call(new Literal('Promise'), [callback]);
        promise.newInstance();
        promise.updateLocationDataIfMissing(this.locationData);
        this.body = new Block([promise]);
      }
